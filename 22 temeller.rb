...
# - Kapsam ---------------------------
degisken = 10
puts "ilk: Değişkenin değeri: #{degisken}" # Değişkenin değeri: 10
...
degistir(20)
puts "iki: Değişkenin değeri: #{degisken}" # Değişkenin değeri: 10
 
degisken = degistir(20)
puts "üç: Değişkenin değeri: #{degisken}" # Değişkenin değeri: 20 